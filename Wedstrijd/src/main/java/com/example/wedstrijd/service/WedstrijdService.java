...
public class WedstrijdService {
    ...
    public void createWedstrijd(WedstrijdRequest wedstrijdRequest) {
        Wedstrijd wedstrijd = Wedstrijd.builder().skuCode(wedstrijdRequest.getSkuCode()).thuisTeam(wedstrijdRequest.getThuisTeam()).uitTeam(wedstrijdRequest.getUitTeam()).datum(wedstrijdRequest.getDatum()).ScheidsrechterID(wedstrijdRequest.getScheidsrechterID()).score(wedstrijdRequest.getScore()).build();
